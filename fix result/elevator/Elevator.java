...
System.out.println("requestOpenDoor("+ elevatorID + ") with elevator "+ ((motionState == STOPPED) ? "stopped" : "moving"));
...
System.out.println("enterElevator("+ elevatorID + ") with door "+ ((doorState == DOOR_OPEN) ? "open" : "closed"));
      if(doorState == DOOR_OPEN){
